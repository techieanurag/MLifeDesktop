    ...
    public partial class Support : Page
    {
        ...
        public void checkifSuccess()
        {
            ...
            else
            {
                Action action1 = () =>
                {
                    notify.Text = "Thank you for supporting us, we will contact you back soon.";
                    submitBtn.Content = "Support Request Logged!";
                    submitBtn.IsHitTestVisible = false;
                };
        ...
        private void backimg_MouseUp(object sender, MouseButtonEventArgs e)
        {
            ...
            _supportFrame.Navigate(new Search());
        }
        ...
        {
            NavigationService nav = NavigationService.GetNavigationService(this);
            _supportFrame.Navigate(new Filter());
        }
        ...
        {
            NavigationService nav = NavigationService.GetNavigationService(this);
            _supportFrame.Navigate(new Main());
        }
        ...
        {
            NavigationService nav = NavigationService.GetNavigationService(this);
            _supportFrame.Navigate(new About());
        }
        ...
        {
            NavigationService nav = NavigationService.GetNavigationService(this);
            _supportFrame.Navigate(new TimeLine());
        }
        ...
        {
            NavigationService nav = NavigationService.GetNavigationService(this);
            _supportFrame.Navigate(new HowTo());
        }
        ...
        private void rbName_TextChanged(object sender, TextChangedEventArgs e)
        {
