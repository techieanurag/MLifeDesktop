...
{
    public partial class RequestOrgan : Page
    {
        //Global Vars
        ...
        private void odCity(object sender, SelectionChangedEventArgs e)
        {
            ...
            MessageBox.Show("You selected your city as " + odCityName);
            }
        }

        private void odOrgan(object sender, SelectionChangedEventArgs e)
        {
            odOrganName = (oBloodBox.SelectedItem as ComboBoxItem).Content.ToString();
            if (odOrganName == "Select an Organ")
            {
                odOrganName = "";
            }
            else
            {
                MessageBox.Show("You selected " + odOrganName);
            }
        ...
        void backroungWorker_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            Action action4 = () =>
            {
                try
                {
                    ...
                    wc.DownloadStringAsync(new Uri("http://techiesin.com/dogood/feed/?s=Organ"));
                }
        ...
        public bool checker()
        {
           if (odOrganName == "")
            {
                MessageBox.Show("Please select organ you want to donate.");
                checkflag = false;
            }
        ...
        private void Button_Click_1(object sender, RoutedEventArgs e)
        {
            ...
            if (isFlag == true)
            {
                ...
                bdSendUrl = "name=" + rbName.Text + "&mobile=" + rbMob.Text + "&organ="+odOrganName+"&hos=" + rbHos.Text + "&city=" + odCityName;
                Debug.WriteLine(bdSendUrl);
                string bdSiteUrl = "http://techiesin.com/dogood/aRequestOrgan.php?" + bdSendUrl;
        ...
        public void refreshButtonClickMethod()
        {
            Action action5 = () =>
            {
                try
                {
                    ...
                    wc.DownloadStringAsync(new Uri("http://techiesin.com/dogood/feed/?s=Organ&random=" + uriRand));
                }
                catch (Exception internetEx)
                {
                    internetEx.ToString();
        ...
        private void backimg_MouseUp(object sender, MouseButtonEventArgs e)
        {
            ...
            _requestOrganFrame.Navigate(new Search());
        }
        ...
        {
            NavigationService nav = NavigationService.GetNavigationService(this);
            _requestOrganFrame.Navigate(new Main());
        }
        ...
        {
            NavigationService nav = NavigationService.GetNavigationService(this);
            _requestOrganFrame.Navigate(new About());
        }
        ...
        {
            NavigationService nav = NavigationService.GetNavigationService(this);
            _requestOrganFrame.Navigate(new TimeLine());
        }
        ...
        {
            NavigationService nav = NavigationService.GetNavigationService(this);
            _requestOrganFrame.Navigate(new HowTo());
        }
