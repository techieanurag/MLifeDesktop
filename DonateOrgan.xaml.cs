...
{
    public partial class DonateOrgan : Page
    {
        //Global Vars
        ...
        private void odOrgan(object sender, SelectionChangedEventArgs e)
        {
            ...
            if (odOrganName == "Select Organ")
            {
                odOrganName = "";
            }
            else
            {
                MessageBox.Show("You pledged to donate " + odOrganName);
            }
        }
        ...
        private void Button_Click_1(object sender, RoutedEventArgs e)
        {
            ...
            if (isFlag == true)
                        ...
                        bdSendUrl = "name=" + rbName.Text + "&mobile=" + rbMob.Text + "&bg=" + oBloodGroup + "&organ=" + odOrganName + "&disease=" + odDisease + "&city=" + odCityName + "&privacy=" + odPrivacy;
                        string bdSiteUrl = "http://techiesin.com/dogood/donateOrgan.php?"+bdSendUrl;
        ...
        private void backimg_MouseUp(object sender, MouseButtonEventArgs e)
        {
            ...
            _donateOrganFrame.Navigate(new Search());
        }
        ...
        {
            NavigationService nav = NavigationService.GetNavigationService(this);
            _donateOrganFrame.Navigate(new Filter());
        }
        ...
        {
            NavigationService nav = NavigationService.GetNavigationService(this);
            _donateOrganFrame.Navigate(new Main());
        }
        ...
        {
            NavigationService nav = NavigationService.GetNavigationService(this);
            _donateOrganFrame.Navigate(new About());
        }
        ...
        {
            NavigationService nav = NavigationService.GetNavigationService(this);
            _donateOrganFrame.Navigate(new TimeLine());
        }
        ...
        {
            NavigationService nav = NavigationService.GetNavigationService(this);
            _donateOrganFrame.Navigate(new HowTo());
        }
